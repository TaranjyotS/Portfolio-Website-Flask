...
*Note*: The database is created under `./instance` folder by the name `contacts.db`. You can use [DB Browser](https://sqlitebrowser.org/) to look at the data in the browser.

3. Run `freeze.py`, this script will convert your dynamic Flask application into static files. It will create a `/build` directory with all your static files.
